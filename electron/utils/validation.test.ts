...
describe('validation', () => {
  ...
  it('strict path rejects traversal', () => {
    ...
    expect(isStrictPath('/home/user/..')).toBe(false)
    expect(isStrictPath('..')).toBe(false)
    expect(isStrictPath('a\\..\\b')).toBe(false)
  })

  it('strict path keeps names that merely start or end with dots', () => {
    expect(isStrictPath('/home/user/..hidden')).toBe(true)
    expect(isStrictPath('/home/user/notes..')).toBe(true)
    expect(isStrictPath('/home/user/...')).toBe(true)
  })
