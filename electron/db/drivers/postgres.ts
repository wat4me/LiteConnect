...
import { mapQueryResult as mapPostgresQueryResult, queryCursorCapped as runPostgresQueryCursorCapped } from './postgresQueryExecution'
import {
  assertIdent,
  cancelledError,
  clampQueryLimits,
...
export class PostgresDriver implements DbDriver {
  ...
  private mapQueryResult(
    ...
    return mapPostgresQueryResult(result, maxRows, start, allowTruncate)
  }

  private queryCursorCapped(
    client: PoolClient,
    sql: string,
    maxRows: number,
    start: number,
    ...
    return runPostgresQueryCursorCapped(
      client, sql, maxRows, start,
