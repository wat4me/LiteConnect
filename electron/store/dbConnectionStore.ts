...
export class DbConnectionStore {
  ...
  private async load(): Promise<void> {
    this.connections = getAppDatabase()
      .getCollection<DbConnection>(COLLECTIONS.dbConnections)
      .map((connection) => this.normalizeLoaded(connection))
  }

  private async persist(): Promise<void> {
    getAppDatabase().replaceCollection(
      COLLECTIONS.dbConnections,
      this.connections,
